...
module.exports = PhpScalingo18Source;

function PhpScalingo18Source(options) {
  _.extend(this, {
    name: 'php-scalingo',
    url: ['https://storage.sbg1.cloud.ovh.net/v1/AUTH_be65d32d71a6435589a419eac98613f2/scalingo-php-buildpack/scalingo-18/manifest.php'],
    all: [],
    stable: [],
    updated: undefined
  }, options);
...
PhpScalingo18Source.prototype.update = function(done) {
  done = done || NOOP;
...
PhpScalingo18Source.prototype._parse = function(body) {
  var versions = [];
