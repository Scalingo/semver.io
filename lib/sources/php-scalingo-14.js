...
module.exports = PhpScalingo14Source;

function PhpScalingo14Source(options) {
  _.extend(this, {
    name: 'php-scalingo',
    url: ['https://storage.sbg1.cloud.ovh.net/v1/AUTH_be65d32d71a6435589a419eac98613f2/scalingo-php-buildpack/scalingo-14/manifest.php'],
    all: [],
    stable: [],
    updated: undefined
  }, options);
...
PhpScalingo14Source.prototype.update = function(done) {
  done = done || NOOP;
...
PhpScalingo14Source.prototype._parse = function(body) {
  var versions = [];
  ...
  this.stable = this.all.filter(function (version) {
    return semver.satisfies(version, '>=7.2.x')
  });
