...
var PhpScalingoSource = require('./sources/php-scalingo');
var PhpScalingo14Source = require('./sources/php-scalingo-14');
var PhpScalingo18Source = require('./sources/php-scalingo-18');
...
module.exports = function App(resolvers) {
  ...
  var resolvers = resolvers || {
    ...
    "php-scalingo-18": new Resolver(new PhpScalingo18Source()),
    "php-scalingo-14": new Resolver(new PhpScalingo14Source()),
    "php-scalingo": new Resolver(new PhpScalingoSource()),
