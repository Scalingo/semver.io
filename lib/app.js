...
module.exports = function App(resolvers) {
  ...
  var resolvers = resolvers || {
    ...
    "php-scalingo-18": new Resolver(new PhpScalingoSource({stack: 'scalingo-18'})),
    "php-scalingo-14": new Resolver(new PhpScalingoSource({stack: 'scalingo-14'})),
    "php-scalingo": new Resolver(new PhpScalingoSource({stack: 'scalingo'})),
