...
module.exports = function App(resolvers) {
  ...
  var resolvers = resolvers || {
    "nginx-scalingo-26": new Resolver(new ScalingoManifestSource(_.merge(_.clone(manifestBaseOptions), {
      name: 'nginx-scalingo-26',
      stack: 'scalingo-26',
      manifestType: "nginx",
      stableRule: '~1.30',
    }))),
    "nginx-scalingo-26-minimal": new Resolver(new ScalingoManifestSource(_.merge(_.clone(manifestBaseOptions), {
      name: 'nginx-scalingo-26-minimal',
      stack: 'scalingo-26-minimal',
      manifestType: "nginx",
      stableRule: '~1.30',
    }))),
    ...
    "php-scalingo-26": new Resolver(new ScalingoManifestSource(_.merge(_.clone(manifestBaseOptions), {
      name: 'php-scalingo-26',
      stack: 'scalingo-26',
      manifestType: "php",
      stableRule: '~8.4',
    }))),
    ...
    "composer-scalingo-26": new Resolver(new ScalingoManifestSource(_.merge(_.clone(manifestBaseOptions), {
      name: 'composer-scalingo-26',
      stack: 'scalingo-26',
